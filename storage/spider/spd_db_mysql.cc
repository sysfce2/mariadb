...
/*
  ...
  Modelled after TABLE_LIST::print().
*/
int spider_db_mbase_util::append_table_list(ha_spider *spider,
                                            spider_fields *fields,
                                            spider_string *str,
                                            TABLE_LIST *table,
                                            ...
                                            table_map eliminated_tables)
{
  ...
  if (!str)
  {
    ...
    if (table->nested_join)
      DBUG_RETURN(append_join(spider, fields, str,
  ...
  if (table->nested_join)
  {
    ...
    if (int error_num= append_join(
          spider, fields, str, &table->nested_join->join_list,
          upper_usable_tables, eliminated_tables))
      DBUG_RETURN(error_num);
    str->append(")");
    DBUG_RETURN(0);
...
/*
  ...
  Modelled after print_table_array().
*/
int spider_db_mbase_util::append_table_array(ha_spider *spider,
                                             spider_fields *fields,
                                             spider_string *str,
                                             TABLE_LIST **table,
                                             TABLE_LIST **end,
                                             ...
                                             table_map eliminated_tables)
{
  ...
  {
    DBUG_ASSERT(!upper_usable_tables);
    if (int error_num= append_table_list(spider, fields, str, *table, NULL,
                                         eliminated_tables))
      DBUG_RETURN(error_num);
    ...
    for (TABLE_LIST **tbl= table + 1; tbl < end; tbl++)
    {
      ...
      if (int error_num= append_table_list(spider, fields, str, curr, NULL,
                                           eliminated_tables))
        DBUG_RETURN(error_num);
  ...
  else                        /* str == NULL */
  {
    ...
    if (int error_num= append_table_list(spider, fields, str, *table,
    ...
    for (TABLE_LIST **tbl= table + 1; tbl < end; tbl++)
    {
      ...
      if (curr->sj_inner_tables)
        DBUG_RETURN(ER_SPIDER_COND_SKIP_NUM);
      if (int error_num= append_table_list(spider, fields, str, curr,
                                           &usable_tables, eliminated_tables))
        DBUG_RETURN(error_num);
      if (curr->on_expr)
      {
...
/*
  ...
  Modelled after print_join().
*/
int spider_db_mbase_util::append_join(ha_spider *spider,
                                      spider_fields *fields,
                                      spider_string *str,
                                      ...
                                      table_map eliminated_tables)
{
  ...
  int error_num= append_table_array(
    spider, fields, str, table, table + tables_to_print, upper_usable_tables,
    eliminated_tables);
  DBUG_RETURN(error_num);
}
...
)
{
  ...
  int error_num = append_join(spider, fields, str,
                              table_list->select_lex->join_list, NULL,
                              eliminated_tables);
  DBUG_RETURN(error_num);
}
